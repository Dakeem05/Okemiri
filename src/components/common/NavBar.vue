...
<template>
  <main class="max-w-7xl mx-auto relative">
    <nav class="py-6 px-10 flex justify-between items-center">
      ...
      <!-- Menu Links -->
      <ul :class="{'hidden': !isMenuOpen, 'flex': isMenuOpen}" class="lg:flex flex-col lg:flex-row gap-6 lg:gap-8 font-medium text-lg lg:pt-0 pt-4 absolute lg:static bg-white lg:bg-transparent w-full lg:w-auto left-0 lg:left-auto top-16 lg:top-auto shadow-lg lg:shadow-none text-black text-center py-10 ">
